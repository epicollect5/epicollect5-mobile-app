  ...
  >
    <ion-header class="ion-no-border">
      ...
      >
        ...
        >{{ labels.project_options }}
        </ion-label>
      </ion-toolbar>
    </ion-header>
    <ion-content ref="drawerContent" class="apply-safe-area-bottom">
      <ion-list>
        <ion-item
            button
  ...
  setup() {
    ...
    const methods = {
      ...
      async openModalBookmarkAdd() {
        ...
        scope.ModalBookmarkAdd.onDidDismiss().then(() => {
          //hide right drawer
          menuController.close();
        });
      ...
      async removeBookmark() {
        ...
        try {
          ...
          await notificationService.showAlert(STRINGS[language].status_codes.ec5_104);
        }
        menuController.close();
      },
      goToDownloadPage() {
