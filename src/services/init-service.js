...
export const initService = {
    ...
    //Get the in-app camera flag for video recording (opt-in, defaults to false)
    async getInAppCameraVideoPreference() {
        return new Promise((resolve, reject) => {
            databaseSelectService.selectSetting(PARAMETERS.SETTINGS_KEYS.IN_APP_CAMERA_VIDEO).then(function (res) {
