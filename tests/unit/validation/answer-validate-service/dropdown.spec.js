...
describe('answerValidateService', () => {
    ...
    it('DROPDOWN answer does not match 1', async () => {
    ...
    it('DROPDOWN answer does not match 2', async () => {
    ...
    it('DROPDOWN answer required is provided', async () => {
    ...
    it('DROPDOWN answer required but missing', async () => {
    ...
    it('DROPDOWN answer NOT required', async () => {
