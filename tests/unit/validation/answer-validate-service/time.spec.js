...
describe('answerValidateService', () => {
    ...
    it('TIME answer required is provided', async () => {

        params.answer.answer = '2022-08-17T16:31:00.000';
    ...
    it('TIME answer required but missing', async () => {
    ...
    it('TIME answer NOT unique form', async () => {
    ...
    it('TIME answer NOT unique hierarchy', async () => {
    ...
    it('TIME answer double entry verification missing', async () => {
    ...
    it('TIME answer double entry verification case sensitive', async () => {

        params.answer.answer = '2022-08-17T16:31:00.000';
        params.confirmAnswer.answer = '2022-08-17t16:31:00.000';
        params.input_details.verify = 'true';
        params.input_details.datetime_format = formats[Math.floor(Math.random() * formats.length)];
    ...
    it('TIME answer double entry verification not matching', async () => {

        params.answer.answer = '2022-08-17T16:31:00.000';
        params.confirmAnswer.answer = '2022-08-17T16:31:10.000';
        params.input_details.verify = 'true';
        params.input_details.datetime_format = formats[Math.floor(Math.random() * formats.length)];
    ...
    it('TIME answer double entry verification matching', async () => {
