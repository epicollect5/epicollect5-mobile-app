...
describe('answerValidateService', () => {
    ...
    it('TEXTBOX answer too long', async () => {
    ...
    it('TEXTBOX answer required is provided', async () => {
    ...
    it('TEXTBOX answer not matching regex 1', async () => {
    ...
    it('TEXTBOX answer not matching regex 2', async () => {
    ...
    it('TEXTBOX answer not matching regex 3', async () => {
    ...
    it('TEXTBOX answer required but missing', async () => {
    ...
    it('TEXTBOX answer unique', async () => {
    ...
    it('TEXTBOX answer NOT unique form', async () => {
    ...
    it('TEXTBOX answer NOT unique hierarchy', async () => {
    ...
    it('TEXTBOX numeric answer unique', async () => {
    ...
    it('TEXTBOX numeric answer NOT unique', async () => {
    ...
    it('TEXTBOX answer double entry verification case sensitive', async () => {
    ...
    it('TEXTBOX answer double entry verification not matching', async () => {
    ...
    it('TEXTBOX answer double entry verification matching', async () => {
