...
describe('answerValidateService', () => {
    ...
    it('CHECKBOX answer does not match', async () => {
    ...
    it('CHECKBOX answer required is provided', async () => {
    ...
    it('CHECKBOX answer required but missing', async () => {
    ...
    it('CHECKBOX answer NOT required', async () => {
