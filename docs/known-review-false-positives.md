...
1. **Partially downloaded entries are not wiped when a download aborts on a mid-download project version change** (`src/services/entries-download-service.js`, `error?.versionChanged` branch).
